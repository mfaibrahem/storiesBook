...
module.exports = {
  ...
  username: function(storyUserId, loggedUserId, storyUsername) {
    if (storyUserId != loggedUserId) {
      return `
        <a href="/api/users/${storyUserId}"><i class="fa fa-user"></i>${storyUsername}</a>
      `;
    } else {
      return '';
    }
